...
<body>
	<div style="">
		<table cellspacing="0" cellpadding="8" border="0" summary=""
			style="width: 100%; font-family: Arial, Sans-serif; border: 1px Solid #ccc; border-width: 1px 2px 2px 1px; background-color: #fff;">
			<tr>
				<td>
					<div style="padding: 2px">
						<img class="bhaa-logo"
							src="http://bhaa.ie/wp-content/uploads/2012/11/headerlogo.jpg"
							width="97" height="100" alt="BHAA Logo"
						...
						<table cellpadding="0" cellspacing="0" border="0"
							...
							<tr>
								<td
									style="padding: 0 1em 10px 0; font-family: Arial, Sans-serif; font-size: 13px; color: #888; white-space: nowrap"
									valign="top">
									<div>
								...
								<td
									style="padding-bottom: 10px; font-family: Arial, Sans-serif; font-size: 13px; color: #222"
									valign="top">'.$when.'</td>
							</tr>
			...
			<tr>
				<td
					style="background-color: #f6f6f6; color: #888; border-top: 1px Solid #ccc; font-family: Arial, Sans-serif; font-size: 11px">
					<p>
						Reminder from <a href="https://www.bhaa.ie/" target="_blank"
							style="">Business Houses Athletic Association</a>
					</p>
					<p>You are receiving this email at the account '.$to.' because you
						just used the BHAA payments system.</p>
					<p>
						<b style="color: red">You must PRINT and bring this email to the
							event registration.</b>
					</p>
				</td>
				<td
					style="background-color: #f6f6f6; color: #888; border-top: 1px Solid #ccc; font-family: Arial, Sans-serif; font-size: 11px">
