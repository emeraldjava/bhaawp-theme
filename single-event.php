...
<div id="content" style="<?php echo $content_css; ?>">
	...
	<div id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
		...
		<div class="flexslider post-slideshow">
			<ul class="slides">
				<li class="video"><?php echo get_post_meta($post->ID, 'pyre_video', true); ?>
				</li>
			</ul>
		</div>
		<?php endif;
		...
		<div class="flexslider post-slideshow">
			<ul class="slides">
				...
				<li><a href="<?php echo $full_image[0]; ?>"
					rel="prettyPhoto['gallery']"><img
						src="<?php echo $attachment_image[0]; ?>"
						alt="<?php echo $attachment->post_title; ?>" /> </a>
				</li>
				<?php endif; ?>
				<?php if($data['posts_slideshow']): ?>
		...
		<div class="meta-info">
			<div class="alignleft">
				...
				<?php the_category(', '); ?>
				<span class="sep">|</span>
				<?php comments_popup_link(__('0 Comments', 'Avada'), __('1 Comment', 'Avada'), '% '.__('Comments', 'Avada')); ?>
			</div>
		</div>
		<?php endif; ?>
		...
		<div class="share-box">
			<h4>
				<?php echo __('Share This Story, Choose Your Platform!', 'Avada'); ?>
			</h4>
			<ul>
				...
				<li class="twitter"><a
					href="http://twitthis.com/twit?url=<?php the_permalink(); ?>">
						Twitter </a>
					<div class="popup">
						<div class="holder">
							<p>Twitter</p>
				...
				<li class="reddit"><a
					href="http://reddit.com/submit?url=<?php the_permalink(); ?>&amp;title=<?php the_title(); ?>">
						Reddit </a>
					<div class="popup">
						<div class="holder">
							<p>Reddit</p>
				...
				<li class="tumblr"><a
					href="http://www.tumblr.com/share/link?url=<?php echo urlencode(get_permalink()); ?>&amp;name=<?php echo urlencode($post->post_title); ?>&amp;description=<?php echo urlencode(get_the_excerpt()); ?>">
						Tumblr </a>
					<div class="popup">
						<div class="holder">
							<p>Tumblr</p>
				...
				<li class="google"><a
					href="http://google.com/bookmarks/mark?op=edit&amp;bkmk=<?php the_permalink(); ?>&amp;title=<?php the_title(); ?>">
						Google +1 </a>
					<div class="popup">
						<div class="holder">
							<p>Google +1</p>
		...
		<div class="about-author">
			<div class="title">
				<h2>
					<?php echo __('About the Author:', 'Avada'); ?>
					<?php the_author_posts_link(); ?>
				</h2>
			</div>
		...
		<div class="related-posts">
			<div class="title">
				<h2>
					<?php echo __('Related Posts', 'Avada'); ?>
				</h2>
			</div>
				...
				<div class="es-carousel">
					<ul>
						...
						<li>
							<div class="image">
								...
								<div class="image-extras">
									<div class="image-extras-content">
										...
										<a class="icon" href="<?php the_permalink(); ?>"><img
											src="<?php bloginfo('template_directory'); ?>/images/link-ico.png"
											alt="<?php the_title(); ?>" /> </a>
										<?php
							...
							?>
										<a class="icon" href="<?php echo $full_image[0]; ?>"
											rel="prettyPhoto['gallery']"><img
											src="<?php bloginfo('template_directory'); ?>/images/finder-ico.png"
											alt="<?php the_title(); ?>" /> </a>
										<h3>
											<?php the_title(); ?>
										</h3>
